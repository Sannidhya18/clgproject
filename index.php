        ...
        <div class="row no-gutters">
          <div class="col-md-4 ftco-animate py-5 nav-link-wrap">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a class="nav-link px-4" id="v-pills-sea-tab" data-toggle="pill" href="#v-pills-sea" role="tab" aria-controls="v-pills-sea" aria-selected="false"><span class="mr-3 flaticon-vision"></span> Orthopaedics</a>

              <a class="nav-link px-4" id="v-pills-spa-tab" data-toggle="pill" href="#v-pills-spa" role="tab" aria-controls="v-pills-spa" aria-selected="false"><span class="mr-3 flaticon-ambulance"></span> Gynaecology</a>
            </div>
          </div>
            ...
            <div class="tab-content pl-md-5" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active py-5" id="v-pills-master" role="tabpanel" aria-labelledby="v-pills-master-tab">
                ...
                <p>Cardiology is the study and treatment of disorders of the heart and the blood vessels. A person with heart disease or cardiovascular disease may be referred to a cardiologist.</p>
 				<p>Cardiology is a branch of internal medicine. A cardiologist is not the same as a cardiac surgeon. A cardiac surgeon opens the chest and performs heart surgery.

				A cardiologist specializes in diagnosing and treating diseases of the cardiovascular system. The cardiologist will carry out tests, and they may some do procedures, such as heart catheterizations, angioplasty, or inserting a pacemaker.</p>
              ...
              <div class="tab-pane fade py-5" id="v-pills-buffet" role="tabpanel" aria-labelledby="v-pills-buffet-tab">
                ...
                <p>Neurology is the branch of medicine concerned with the study and treatment of disorders of the nervous system. The nervous system is a complex, sophisticated system that regulates and coordinates body activities. It has two major divisions:</p>

				<p>Central nervous system: the brain and spinal cord</p>
				<p>Peripheral nervous system: all other neural elements, such as eyes, ears, skin, and other "sensory receptors"</p>
                <!-- <p><a href="#" class="btn btn-primary">Learn More</a></p> -->
              </div>
              ...
              <div class="tab-pane fade py-5" id="v-pills-fitness" role="tabpanel" aria-labelledby="v-pills-fitness-tab">
                ...
                <p>Medical diagnosis is the process of determining which disease or condition explains a person's symptoms and signs. It is most often referred to as diagnosis with the medical context being implicit. The information required for diagnosis is typically collected from a history and physical examination of the person seeking medical care. Often, one or more diagnostic procedures, such as medical tests, are also done during the process. Sometimes posthumous diagnosis is considered a kind of medical diagnosis.</p>

				<p>Diagnosis is often challenging, because many signs and symptoms are nonspecific. For example, redness of the skin (erythema), by itself, is a sign of many disorders and thus does not tell the healthcare professional what is wrong. Thus differential diagnosis, in which several possible explanations are compared and contrasted, must be performed. This involves the correlation of various pieces of information followed by the recognition and differentiation of patterns. Occasionally the process is made easy by a sign or symptom (or a group of several) that is pathognomonic.</p>
              ...
              <div class="tab-pane fade py-5" id="v-pills-sea" role="tabpanel" aria-labelledby="v-pills-sea-tab">
                ...
                <h2 class="mb-4">Orthopaedics Departments</h2>
                <p>Orthopaedics is the medical specialty that focuses on injuries and diseases of your body's musculoskeletal system. This complex system, which includes your bones, joints, ligaments, tendons, muscles, and nerves, allows you to move, work, and be active.</p>

				<p>Once devoted to the care of children with spine and limb deformities, orthopaedists now care for patients of all ages, from newborns with clubfeet to young athletes requiring arthroscopic surgery to older people with arthritis. And anybody can break a bone.</p>
                <!-- <p><a href="#" class="btn btn-primary">Learn More</a></p> -->
              </div>
              ...
              <div class="tab-pane fade py-5" id="v-pills-spa" role="tabpanel" aria-labelledby="v-pills-spa-tab">
                ...
                <h2 class="mb-4">Gynaecology Departments</h2>
                <p>Gynaecology or gynecology (see spelling differences) is the medical practice dealing with the health of the female reproductive systems (vagina, uterus, and ovaries) and the breasts. Outside medicine, the term means "the science of women". Its counterpart is andrology, which deals with medical issues specific to the male reproductive system.</p>

				<p>Almost all modern gynaecologists are also obstetricians (see obstetrics and gynaecology). In many areas, the specialities of gynaecology and obstetrics overlap.</p>
                <!-- <p><a href="#" class="btn btn-primary">Learn More</a></p> -->
              </div>
            </div>
          </div>
    ...
    <section class="ftco-section">
        ...
        <div class="row">
        	<div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/exercise.jpg);">
	                <div class="box">
	                  <h2>Exercise</h2>
	                  <p>Do it daily!!</p>
	                </div>
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo;Exercise can help prevent excess weight gain or help maintain weight loss. It can also help improve cognitive function and helps lower the risk of death from all causes. You may also feel better about your appearance and yourself when you exercise regularly.&rdquo;</p>
	                </blockquote>
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/smoke.jpg);">
	                <div class="box">
	                  <h2>Smoking</h2>
	                  <p>Stop it!</p>
	                </div>
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo;Smokers run slower and can't run as far, like being old before you're old.It takes just 8 seconds for nicotine from cigarettes to reach your brain and change the way it works.It takes just 8 seconds for nicotine from cigarettes to reach your brain and change the way it works.&rdquo;</p>
	                </blockquote>
	                <!-- <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(images/sleep.jpg);">
	                <div class="box">
	                  <h2>Sleep</h2>
	                  <p>Say no to sleep depriviation!</p>
	                </div>
	              </div>
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>&ldquo;How you feel during your waking hours often hinges on how well you sleep. Similarly, the cure for daytime fatigue and sleep difficulties can often be found in your daily routine and lifestyle choices.&rdquo;</p>
	                </blockquote>
	                <!-- <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalAppointmentLabel">Login Portal</h5>
          ...
          <div class="modal-body">
            <div class="container">
    		<div class="row">
    			<div class="col-md-5" style="border:1px solid orange;box-shadow: 0px 0px 5px 5px orange;padding: 10px;margin-right: 30px;">
    				<div style="text-align: center;border:font-weight: bold;font-size: 20px;"><a href="HMS/user-login.php">PATIENT LOGIN</a></div>
    			</div>
    			<div class="col-md-5" style="border:1px solid orange;box-shadow: 0px 0px 5px 5px orange;padding: 10px;">
    				<div style="text-align: center;border:font-weight: bold;font-size: 20px;"><a href="HMS/Admin/index.php">ADMIN LOGIN</a></div>
    			</div>
    			<div class="col-md-5" style="border:1px solid orange;box-shadow: 0px 0px 5px 5px orange;padding: 10px;">
    				<div style="text-align: center;border:font-weight: bold;font-size: 20px;"><a href="HMS/doctor/index.php">DOCTOR LOGIN</a></div>
    			</div>
